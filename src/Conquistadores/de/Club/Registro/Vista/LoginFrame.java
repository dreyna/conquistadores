...
public class LoginFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Josue");

        jLabel4.setFont(new java.awt.Font("Arial Black", 1, 12)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(0, 0, 204));
        jLabel4.setText("Club de Conquistadores Itiel");

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Conquistadores/de/Club/Registro/Imagenes/user.png"))); // NOI18N
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        ...
        b = new String(txtContraseña.getPassword());
        if (a.equals("Josue") && b.equals("977948170")){
            form.setVisible(true);
            this.setVisible(false);
            JOptionPane.showMessageDialog(null, "Bienvenido al Sistema de Registro");
        }else{
            JOptionPane.showMessageDialog(null, "Intente de vuelta por favor");
        }
